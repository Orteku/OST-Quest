...
import { handleRegister, handleLogin, handleForgotPassword, handleResetPassword } from './routes/email.js';
...
import { handleGetMe, handleSetUsername } from './routes/user.js';
...
export default {
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      // ── Steam OpenID ────────────────────────────────────────────────────
      if (path === '/auth/steam'            && method === 'GET') return handleSteamStart();
